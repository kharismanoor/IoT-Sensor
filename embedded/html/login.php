...
>
  <head>
    ...
    <title>IOT Monitoring Suhu dan Jarak</title>
    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.php" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder" UPPER >IOT Vokasi</span>
                </a>
              </div>
              <!-- /Logo -->
        ...
        <?php if($_GET['gagal']=="userKosong"){?>
          ...
          <?php }?>
      <?php }?>
              <h4 class="mb-2" style="text-align:center">Welcome to Internet of Thing</h4>
              <p class="mb-4" style="text-align:center">Please sign-in to your account</p>

              <form id="formAuthentication" class="mb-3" action="konfirmasilogin.php" method="post">
