...
>
  <head>
    ...
    <title>Dashboard | IOT Vokasi</title>
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2 ">iot vokasi</span>
            </a>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-5 container-p-y">
              <div class="row">
              ...
              <div class="row">
                <div class="col-6 col-lg-15 mb-4">
                  <div class="card">
                        ...
                        <div class="tab-pane fade show active"  role="tabpanel">
                          <div class="d-flex p-4 pt-4">
                            <div class="card-title mb-0">
                              <h5 class="m-0 me-2">Kelembaban</h5>
                              <?php
    $sql = "SELECT nilai FROM tampung_data_device WHERE nama_alat='sensor_jarak1' 
    ...
    <div class="d-flex justify-content-center pt-0 gap-4" id="chart_div" style="width: 500px; height: 150px;"></div>
                            </div>
                          </div>
                          </div>
                          </div>
                                ...
                                <!-- Expense Overview -->
                                <div class="col-sm-15 col-md-15 col-lg-15 order-0">
                                          ...
                                          <div class="d-flex p-4 pt-4">
                                            <div class="card-title mb-0">
                                              ...
                                              <script>
                                                  ...
                                                  <div class="d-flex justify-content-center pt-8 gap-8"  style="width: 900px; height: 350px;"></div>
                                            </div>
                                          </div>
